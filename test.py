...
response = phoenix_tracker.generate_with_single_input(prompt = english_test_check_propmt, model = "gpt-3.5-turbo", family="openai")
# end_time = time.time()
# print(f"Time taken for gpt-3.5-turbo: {end_time - start_time} seconds")
print(f"Response GPT-3.5-turbo: {response}")
# start_time = time.time()
response = phoenix_tracker.generate_with_single_input(prompt = english_test_check_propmt, model = "gpt-5.2", family="openai")
# end_time = time.time()
